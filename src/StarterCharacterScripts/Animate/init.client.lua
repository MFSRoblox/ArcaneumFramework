local AnimationPackage = game:GetService("ReplicatedStorage"):WaitForChild("Animations", 60) do
	local Animations = AnimationPackage:GetChildren()
	for i=1, #Animations do
		local NewAnim = Animations[i]:Clone()
